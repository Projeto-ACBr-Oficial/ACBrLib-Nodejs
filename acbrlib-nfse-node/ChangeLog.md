...
- `README.md` atualizado com seção de Changelog, badge de versão `1.0.12` e exemplos de inicialização com `path` e `os` para resolução cross-platform da DLL/SO e do arquivo de configuração
