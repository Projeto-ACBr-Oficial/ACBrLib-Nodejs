...
export interface TypeACBrNFeMT {
    ...
    NFE_DistribuicaoDFePorUltNSU: (handle: any, AcUFAutor: number, eCNPJCPF: string, eultNSU: string, sResposta: Buffer, esTamanho: any) => number
...
export default class ACBrLibNFeBridgeMT {
    ...
    constructor(libraryPath: string) {
        ...
        this.acbrNativeLib = {
            ...
            NFE_SalvarEventoPDF: acbrnfe.func('NFE_SalvarEventoPDF', 'int', ['void *', 'string', 'string', 'char*', 'int*']),
